 ...
 *
 * The argument should be in the form: Understrap\Namespace. The
...
function namespace_autoload( $class_name ) {
    ...
    if ( false === strpos( $class_name, 'Understrap_Child' ) ) {
        return;
    }
    ...
    $filepath  = trailingslashit( dirname( dirname( __FILE__ ) ) . '/classes/' . $namespace );
    $filepath .= $file_name;
